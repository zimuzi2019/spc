...
public class SheetT2SingleGenerator {
    public static byte[] generateT2Single(String graphType, Integer subgroupTotal, Integer varNum) {
        // 子组总数
        int n = subgroupTotal;
        // 变量个数
        int m = varNum;
        ...
        XSSFSheet sheet = wb.createSheet("单值多变量T^2控制图数据登入表");
        ...
        cell.setCellValue("单值多变量T^2控制图数据登入表");
        ...
        colNum = colNum + 3;
        cell = row.createCell(colNum);
        cell.setCellValue("单值多变量T^2控制图"); // 写死了
